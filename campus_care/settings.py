...
OTP_SIGNING_KEY = config('OTP_SIGNING_KEY', default=SECRET_KEY)
AUDIT_LOG_SIGNING_KEY = config('AUDIT_LOG_SIGNING_KEY', default=SECRET_KEY)
AUDIT_LOG_SIGNATURE_VERSION = 'hmac-sha256-v2'
