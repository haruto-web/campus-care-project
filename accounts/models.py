...
class AuditLog(models.Model):
    ACTION_CHOICES = [
        ...
        ('STUDENT_RESTORED_TO_CLASS', 'Student Restored to Class'),
        ...
        ('INTERVENTION_RESTORED', 'Intervention Restored'),
        ...
        ('REGISTRATION_RESTORED', 'Registration Restored'),
        ('APPROVED_STUDENT_STATUS_CHANGED', 'Approved Student Status Changed'),
        ('APPROVED_STUDENT_STATUS_RESTORED', 'Approved Student Status Restored'),
        ('MESSAGING_SUSPENSION_LIFTED', 'Messaging Suspension Lifted'),
        ('MESSAGING_SUSPENSION_RESTORED', 'Messaging Suspension Restored'),
